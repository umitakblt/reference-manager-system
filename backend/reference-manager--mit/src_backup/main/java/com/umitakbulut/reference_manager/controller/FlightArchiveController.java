    ...
    public ResponseEntity<List<FlightResponseDTO>> getAllArchivedFlights() {
        List<FlightResponseDTO> archivedFlights = flightArchiveService.getAllArchivedFlights()
                ...
                .map(archive -> {
                    ...
                    dto.setOriginStationName(archive.getOriginStationCode()); // Geçici olarak code'u name olarak kullan
                    dto.setDestinationStationName(archive.getDestinationStationCode()); // Geçici olarak code'u name olarak kullan
