...
public class FlightArchiveServiceImpl implements FlightArchiveService {
    ...
    public void saveFromFlight(Flight flight) {
        try {
            // Duplicate kontrolü - aynı flight number zaten arşivlenmiş mi?
            ...
            // Manuel olarak FlightArchive oluştur
            ...
            // Güvenli şekilde ilişkili entity'lerin bilgilerini al
            ...
            // Status ve description bilgilerini ekle
